...
Dashboards that fit on screen are captured in a single pass. Version 1.2.2 fixes the scroll-container error for these dashboards. The app page includes a quick-start guide and example screenshots.
